...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      {Quantitative Software Engineer Intern}{June 2025 - August 2025}
      {Morgan Stanley}{New York, NY}
      \resumeItemListStart
          \resumeItem{Migrated a \textbf{C++} quant. trading app to the web, reducing loading speeds by \textbf{50\%}, and integrated \textbf{Grafana}.}
          \resumeItem{Developed \textbf{Python} pipelines for risk management, improving report quality by \textbf{45\%} by integrating market data.}
