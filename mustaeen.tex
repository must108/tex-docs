  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Developed \textbf{Visual Basic} scripts for \textbf{Excel} task automation, saving \textbf{10+} hours of manual data collection. }
    \resumeItemListEnd
    \resumeSubheading
...
\section{Projects}
    \resumeSubHeadingListStart
        ...
        \resumeProjectHeading
          ...
          \resumeItemListEnd
      \resumeProjectHeading
          {\textbf{\href{https://github.com/naavis-app/app}{Naavis}} $|$ \emph{Next.js, React, TypeScript, PostgreSQL, Prisma, Redis, Amazon S3, tRPC, Tailwind CSS, Jest, Vitest}}{June 2021 -- Present}
          \resumeItemListStart
            ...
            \resumeItem{Used \textbf{Amazon S3}, \textbf{tRPC}, and \textbf{RESTful APIs} for assets, reducing query speed by \textbf{50\%}, and latency by \textbf{80\%}.}
          \resumeItemListEnd
    \resumeSubHeadingListEnd
%
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Tools}{: Git, GitHub, GitLab, Jira, AWS, Microsoft Azure, Prisma, Redis, Docker, MongoDB, Jupyter Notebook, Linux} \\
