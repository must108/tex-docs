...
\section{Projects}
    ...
    \resumeSubHeadingListStart
      \resumeProjectHeading
          {\textbf{\href{https://github.com/must108/multi-wordle}{Multi-Wordle}} $|$ \emph{Next.js, React, TypeScript, PostgreSQL, Prisma, Node.js, Tailwind CSS}}{June 2021 -- Present}
          \resumeItemListStart
            ...
            \resumeItem{Utilized the binary search algorithm to efficiently search the database and validate user input, which decreased searching runtime by over 95\%.}
          \resumeItemListEnd
        ...
        \resumeProjectHeading
          ...
          \resumeItemListStart
            ...
            \resumeItem{Used CircleCI for CI/CD, allowing for automated unit testing, building, release, and deployment to pip.}
